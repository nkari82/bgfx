...
struct bgfx_interface_vtbl
{
    ...
    bgfx_frame_buffer_handle_t (*create_frame_buffer_from_nwh)(void* _nwh, void* _ndt, uint16_t _width, uint16_t _height, bgfx_texture_format_t _format, bgfx_texture_format_t _depthFormat);
