...
//			}
	...
	struct BX_NO_VTABLE RendererContextI
	{
		...
		virtual void* createTexture(TextureHandle _handle, const Memory* _mem, uint64_t _flags, uint8_t _skip, uintptr_t* _ptr = NULL, uint16_t* _width = NULL, uint16_t* _height = NULL, uint8_t* _format = NULL) = 0;
